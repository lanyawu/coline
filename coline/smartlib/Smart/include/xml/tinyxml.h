...
public:
	...
	*/
	...
	virtual void SaveToString(TIXML_STRING &strXml, int nDepth) const = 0;
	...
	*/
	...
	static void EncodeString(const char *szSrc, TIXML_STRING &strOut);
...
public:
	...
	*/
    ...
    virtual void SaveToString(TIXML_STRING &strXml, int nDepth) const;
	// [internal use]
...
public:
	...
	*/
	...
	void SaveToString(TIXML_STRING &strXml, int nDepth) const;
	...
	*/
	...
	/*Load xml document from raw binary data stream
	*/
	bool Load( const char*, const int max );
	#ifdef TIXML_USE_STL
